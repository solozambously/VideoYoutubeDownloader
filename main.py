...
print('Bienvenue')
print('Téléchargez gratuitement une vidéo YouTube(MP4) ou seulement son audio(WEBM) avec seulement un lien !')
print('Create By SoloZambously')
input_num_streams = input('Tapez "1": Pour une vidéo avec l\'audio //// Tapez "2": Pour l\'audio d\'une vidéo : ')
...
# Pour une vidéo
if input_num_streams ==  "1":
    num_streams = 22

# Pour un audio
if input_num_streams == "2":
    num_streams = 251
...
# print(url.streams)
stream = url.streams.get_by_itag(num_streams)
stream.download()
